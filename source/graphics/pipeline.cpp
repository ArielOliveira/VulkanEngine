...
namespace Graphics {
    Pipeline::Pipeline(const vk::raii::Device &device, const vk::GraphicsPipelineCreateInfo &createInfo, vk::raii::PipelineLayout& pipelineLayout, vk::raii::DescriptorSetLayout &descriptorSetLayout) :
        ...
        descriptorSetLayout(std::move(descriptorSetLayout)) {
            std:: cout << "GRAPHICS PIPELINE CONSTRUCTOR" << '\n';
        }
    ...
    Pipeline::Pipeline(const vk::raii::Device &device, const vk::GraphicsPipelineCreateInfo &createInfo, vk::raii::PipelineLayout& pipelineLayout) :
        pipeline(vk::raii::Pipeline(device, nullptr, createInfo)),
        pipelineLayout(std::move(pipelineLayout)) {
            std:: cout << "NO DESCRIPTOR GRAPHICS PIPELINE CONSTRUCTOR" << '\n';
        }
    ...
    Pipeline Pipeline::createSimpleGraphicsPipeline(const vk::raii::Device &device, const vk::Extent2D &swapChainExtent, const vk::SurfaceFormatKHR &swapChainSurfaceFormat) {
        std::cout << "CREATING REGULAR GRAPHICS PIPELINE" << '\n';

        vk::raii::ShaderModule shaderModule = createShaderModule("helloTriangleSimple.spv", device);
    ...
    void Pipeline::createSimpleGraphicsDescriptorPool(const vk::raii::Device &device) {
        std::array poolSize {
    ...
    void Pipeline::createSimpleGraphicsDescriptorSets(const vk::raii::Device &device, const vector<vk::raii::Buffer> &uniformBuffers) {
